...
// every interface is a part of a via or link
typedef struct interface_ {
	char if_name[IF_NAME_SIZE];
	struct node_ *att_node; // owning node
	struct link_ *link; // a wire or link
...
struct node_ {
	...
	glthread_t graph_glue; // linked list also called thread
    unsigned int udp_port_number; // UDP port number
    int udp_sock_fd;              // File Descriptor
...
typedef struct graph_ {
	...
	// just a special form of linked list
